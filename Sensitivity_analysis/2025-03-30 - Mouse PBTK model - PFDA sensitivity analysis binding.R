...
# Permeability
P_app           = 8.44*10^-6             # apparent permeability of the chemical (passive membrane diffusion) (cm/s)

# Partition coefficients to tissue constituents
K_FABP          = 10^3.72                  # Fatty acid binding protein-water partition coefficient (L_w/L_FABP)
K_SA            = 10^4.57                  # Human serum albumin-water partition coefficient (L_w/L_SA)
K_Glob          = 10^3.68                  # Globulin-water partition coefficient (L_w/L_SP)
K_SP            = 10^2.96                  # Structural proteins-water partition coefficient (L_w/L_SP)
K_ML            = 10^4.66                  # Membrane lipid-water partition coefficient (L_w/L_ML)
...
P_NTCP          = 2.35*10^-7             # NTCP-mediated active transport membrane permeability (cm/s)
P_OAT1          = 0                      # OAT1-mediated active transport membrane permeability (cm/s)
P_OAT2          = 2.66*10^-7             # OAT2-mediated active transport membrane permeability (cm/s)
P_OAT3          = 7.14*10^-7             # OAT3-mediated active transport membrane permeability (cm/s)
