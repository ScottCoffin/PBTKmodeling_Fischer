...
# Permeability
P_app           = 1.16*10^-5             # apparent permeability of the chemical (passive membrane diffusion) (cm/s)

# Partition coefficients to tissue constituents
K_FABP          = 10^3.80                  # Fatty acid binding protein-water partition coefficient (L_w/L_FABP)
K_SA            = 10^4.71                  # Human serum albumin-water partition coefficient (L_w/L_SA)
K_Glob          = 10^4.64                  # Globulin-water partition coefficient (L_w/L_SP)
K_SP            = 10^3.42                  # Structural proteins-water partition coefficient (L_w/L_SP)
K_ML            = 10^4.54                  # Membrane lipid-water partition coefficient (L_w/L_ML)
...
P_OAT1          = 1.81*10^-6             # OAT1-mediated active transport membrane permeability (cm/s)
P_OAT2          = 1.43*10^-7             # OAT2-mediated active transport membrane permeability (cm/s)
P_OAT3          = 8.18*10^-7             # OAT3-mediated active transport membrane permeability (cm/s)
