...
# Permeability
P_app           = 1.40*10^-6             # apparent permeability of the chemical (passive membrane diffusion) (cm/s)

# Partition coefficients to tissue constituents
K_FABP          = 10^2.30                  # Fatty acid binding protein-water partition coefficient (L_w/L_FABP)
K_SA            = 10^4.08                  # Human serum albumin-water partition coefficient (L_w/L_SA)
K_Glob          = 10^1.81                  # Globulin-water partition coefficient (L_w/L_SP)
K_SP            = 10^1.30                  # Structural proteins-water partition coefficient (L_w/L_SP)
K_ML            = 10^2.89                  # Membrane lipid-water partition coefficient (L_w/L_ML)

# Membrane transporters (expressed as permeabilities)
P_OATP1B2       = 2.06*10^-7             # OATP1B3-mediated active transport membrane permeability (cm/s)
P_OATP2B1       = 1.40*10^-7             # OATP2B1-mediated active transport membrane permeability (cm/s)
P_NTCP          = 0                      # NTCP-mediated active transport membrane permeability (cm/s)
P_OAT1          = 1.03*10^-6             # OAT1-mediated active transport membrane permeability (cm/s)
P_OAT2          = 2.30*10^-8             # OAT2-mediated active transport membrane permeability (cm/s)
P_OAT3          = 1.25*10^-5             # OAT3-mediated active transport membrane permeability (cm/s)
