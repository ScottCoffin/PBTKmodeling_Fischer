...
# Permeability
P_app           = 3.77*10^-6             # apparent permeability of the chemical (passive membrane diffusion) (cm/s)

# Partition coefficients to tissue constituents
K_FABP          = 10^3.94                  # Fatty acid binding protein-water partition coefficient (L_w/L_FABP)
K_SA            = 10^4.26                  # Human serum albumin-water partition coefficient (L_w/L_SA)
K_Glob          = 10^2.81                  # Globulin-water partition coefficient (L_w/L_SP)
K_SP            = 10^2.17                  # Structural proteins-water partition coefficient (L_w/L_SP)
K_ML            = 10^4.16                  # Membrane lipid-water partition coefficient (L_w/L_ML)

# Membrane transporters (expressed as permeabilities)
P_OATP1B2       = 1.99*10^-7             # OATP1B3-mediated active transport membrane permeability (cm/s)
P_OATP2B1       = 1.31*10^-7             # OATP2B1-mediated active transport membrane permeability (cm/s)
P_NTCP          = 2.57*10^-7             # NTCP-mediated active transport membrane permeability (cm/s)
P_OAT1          = 0                      # OAT1-mediated active transport membrane permeability (cm/s)
P_OAT2          = 5.19*10^-9             # OAT2-mediated active transport membrane permeability (cm/s)
P_OAT3          = 1.34*10^-6             # OAT3-mediated active transport membrane permeability (cm/s)
