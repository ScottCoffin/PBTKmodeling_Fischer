...
V_blood_total      = 20                       # Total volume of blood (cm3_blood)
...
rigidode <- function(t, y, parms) {
  ...
  J_kidneys_filtrate       = P_app * A_GF/3 * (C_filtrate * f_free_filtrate * 1/VF_water_filtrate - C_free_kidneys)
...
# Write results and summary metrics to an Excel file
write.xlsx(list(Simulation_Results = results.final, Summary_Metrics = summary_metrics), "results.xlsx")
