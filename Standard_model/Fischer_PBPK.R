### Generic function to easily run model on available PFAS with given exposure scenario ###
### output is a dataframe of compartment concentrations at each time point ##
